...
STRIPE_PRICE_ADDON_ADJUSTMENT = os.environ.get('STRIPE_PRICE_ADDON_ADJUSTMENT', '')
STRIPE_PRICE_ADDON_POSTURE = os.environ.get('STRIPE_PRICE_ADDON_POSTURE', '')
STRIPE_PRICE_ADDON_BLOOD = os.environ.get('STRIPE_PRICE_ADDON_BLOOD', '')
STRIPE_PRICE_TRAINER_GROWING = os.environ.get('STRIPE_PRICE_TRAINER_GROWING', '')
STRIPE_PRICE_TRAINER_UNLIMITED = os.environ.get('STRIPE_PRICE_TRAINER_UNLIMITED', '')
