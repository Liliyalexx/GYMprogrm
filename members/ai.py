...
def generate_program(member, exercise_library: list, extra_notes: str = '', posture_analysis: str = '') -> dict:
    ...
    profile_text = (
        ...
        'STEP 6 — CONTRAINDICATED EXERCISES FOR THIS CLIENT\n'
        '  Based on all the above, list which exercises from the library you are EXCLUDING and WHY.\n'
    ...
    resp = _client().messages.create(
        ...
        system=(
            ...
            'You never design generic programs — every exercise choice, volume, and intensity is dictated by this specific client\'s '
            'age, health, posture, blood markers, medications, activity level, and goal. '
            'A 42-year-old moderately active woman gets a completely different program from a 25-year-old athlete. '
            'A sedentary person gets 3–4 exercises per session, not 8. '
            'You strictly obey the volume caps and rep ranges from the assessment protocol. '
